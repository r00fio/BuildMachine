...
Keyboard.fireOnClickPersonalAcc = function() {
    cordova.fireWindowEvent('keyboard_onClickPersonalAcc');
};

Keyboard.fireOnClickContactList = function() {
    cordova.fireWindowEvent('keyboard_onClickContactList');
};

/*
 * Показать клавиатуру с кнопками
 */
Keyboard.showWithButtons = function(successCallback) {
    exec(null, null, "Keyboard", "showWithButtons", []);
};
